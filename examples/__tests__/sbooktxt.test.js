...
test("sbooktxt search", async () => {
  ...
  expect(value[0]).toStrictEqual({
    title: "道诡异仙",
    url: "https://www.sbooktxt.com/78_78552/",
    author: "狐尾的笔",
    cover: "https://www.sbooktxt.com/files/article/image/78/78552/78552s.jpg",
    intro:
...
test("sbooktxt fetch chapters", async () => {
  const source = new BookSource(s, null);
  const result = await source.chapters("https://www.sbooktxt.com/17_17180/");
  source.destroy();
...
test("sbooktxt fetch chapter", async () => {
  ...
  const result = await source.chapter(
    "https://www.sbooktxt.com/17_17180/66095.html"
  );
  source.destroy();
