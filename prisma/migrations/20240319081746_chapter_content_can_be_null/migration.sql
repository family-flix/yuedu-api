...
INSERT INTO "new_SearchedNovelChapter" ("chapter_profile_id", "content", "created", "error", "id", "name", "order", "searched_novel_id", "unique_id", "updated", "url") SELECT "chapter_profile_id", "content", "created", "error", "id", "name", "order", "searched_novel_id", "unique_id", "updated", "url" FROM "SearchedNovelChapter";
